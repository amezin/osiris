...
namespace TerrainDemo
{
    class Ship
    {
        ...
        /// </summary>
        private const float ThrustForce = 240.0f;
        ...
        public void Reset()
        {
        	float x = _terrain.Model.HeightMap.Width / 2.0f;
        	float z = _terrain.Model.HeightMap.Height / 2.0f;
			Position = new Vector3(x, _terrain.Model.HeightMap[x, z] + 10.0f, z);
